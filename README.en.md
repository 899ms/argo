...
- **216 sources (182 usable with no key), 89 domains**: general web + finance / macro / film / sports / geo / orgs / media / chemistry / academic / code (source of truth: `config.yaml` + `engines/specs/*.yaml`)
...
Config currently has **216** sources (**182** usable with no key) and **89** domains (see `config.yaml` and `--list-engines`).
