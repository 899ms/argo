...
4. **El ecosistema libre basta.** APIs abiertas de gobiernos/academia/estándares/seguridad + motores sin clave cubren la mayoría de dominios (194 sin configuración).
5. **Calidad medible.** Pisos golden de ranking, gates de ablación de fusión y controles negativos de enrutamiento.

> v2.8.8 lo implementa todo: 232 fuentes, 90 dominios, 194 sin clave.
...
- **232 fuentes, 90 dominios** (194 sin configuración): web general + finanzas / macro / cine / deportes / geo / orgs / media / química / academia / código (fuente de verdad: `config.yaml`)
